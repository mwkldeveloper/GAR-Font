...
from model.tokenizer.lpips import LPIPS
...
class VQ_loss(nn.Module):
    ...
    def forward(self, codebook_loss, inputs, reconstructions, global_step,
        ...
        # codebook loss
        cb_loss = codebook_loss[0] + codebook_loss[1] + codebook_loss[2] # vq_loss, commit_loss, entropy_loss

        
        loss = self.rec_weight * rec_loss + self.perceptual_weight * p_loss + self.codebook_weight * cb_loss

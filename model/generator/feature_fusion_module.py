...
class StyleAttentionBlock(nn.Module):
    ...
    def _attention(self, Q, K, V):
        ...
        attn_output = attn_output.transpose(1, 2).contiguous().view(-1, len_q, self.z_channel)
        return attn_output
...
class FeatureFusionModule(nn.Module):
    ...
    def forward(self, content_feat, style_feats):
        ...
        style_seq = style_feats.view(B, n_ref, C, H * W).permute(0, 1, 3, 2).reshape(B, n_ref * H * W, C) # [B, n_ref*HW, C]
